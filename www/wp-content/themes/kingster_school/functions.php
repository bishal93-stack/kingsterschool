...
function kingster_school_scripts() {
	wp_enqueue_style( 'kingster_school-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'kingster_school-style', 'rtl', 'replace' );

	wp_enqueue_script( 'kingster_school-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
